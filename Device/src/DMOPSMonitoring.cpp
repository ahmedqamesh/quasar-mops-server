...
/*  © Copyright CERN, 2015. All rights not expressly granted are reserved.
    ...
    on 2020-05-06T15:56:36.047+02:00
...
namespace Device
{
  ...
  /* sample ctr */
  DMOPSMonitoring::DMOPSMonitoring (const Configuration::
				    MOPSMonitoring & config,
				    Parent_DMOPSMonitoring *
				    parent):Base_DMOPSMonitoring (config,
								  parent)
  ...
  /* sample dtr */
  DMOPSMonitoring::~DMOPSMonitoring ()
  {
  }
